      ...
      <div className="container">
        ...
        <div className="meet-team-header">
          ...
          <div className="meet-team-arrows">
            <button className="mt-arrow" onClick={prev} disabled={active === 0} aria-label="Previous">
              <ChevronLeft size={20} />
            </button>
            <button className="mt-arrow" onClick={next} disabled={active === team.length - 1} aria-label="Next">
                  ...
                  <div className="mt-card-socials">
                    ...
                    {member.email && (
                      <a href={`mailto:${member.email}`}
                        className="mt-social-btn mt-social-email" aria-label={`Email ${member.name}`}
                        onClick={e => e.stopPropagation()}>
                        <Mail size={16} />
                      </a>
                    )}
